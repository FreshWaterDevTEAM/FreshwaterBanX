...
/**
 * Compile-time stub of Matrix's PlayerViolationCommandEvent. NOT bundled into the jar; the real
 * Matrix class is used at runtime. Signatures mirror the published Matrix API.
 */
