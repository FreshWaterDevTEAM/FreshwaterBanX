...
public final class FreshwaterBanXBridge extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(
                new ViolationListener(this, cancelMatrix, minViolations, serverName, debug), this);

        getLogger().info("FreshwaterBanX-Bridge enabled (cancel-matrix-commands=" + cancelMatrix
